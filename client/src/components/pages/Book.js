    ...
    return (
      <div>
        ...
        { this.state.currentStep === 4 &&
          <Complete name={this.state.travellerInfo.name} travellerInfo={JSON.stringify(this.state.travellerInfo)} travellerSchedule={JSON.stringify(this.state.travellerSchedule)} tripID={this.props.location.state.id} agent={this.props.location.state.agent} dest={this.props.location.state.dest}/>
        }
